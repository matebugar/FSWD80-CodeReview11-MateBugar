...
<fieldset>
   ...
   <form action="actions/a_updatePlace.php"  method="post">
       <table  cellspacing="0" cellpadding= "0">
           ...
           <tr>
               <th>Descript</th>
               <td><input type="text"  name="descript" placeholder ="Descript" value="<?php echo $data['descript'] ?>"  /></td>
           </tr>  

           <tr>
             <input type="hidden" name="placeId" value="<?= $placeId; ?>">
               <td><button  type= "submit">Save Changes</button ></td>
               <td><a  href= "placeAdmin.php"><button  type="button" >Back</button ></a ></td >
           </tr>
       </table>
   </form >
