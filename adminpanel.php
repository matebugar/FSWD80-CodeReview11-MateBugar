...
<body >
  ...
  <p class="leadJumbo">Clicking on the ADD button you can insert new restaurant into the library.<br>
  Pushing the EDIT and DELETE buttons are triggering the functions.  
  </p>
  <a class="btn  btn-lg" href="createRes.php" role="button">Add restaurant</a>
</div>
