...
<body >
  ...
  <p class="leadJumbo">Clicking on the ADD button you can insert new media into the library.<br>
  Pushing the EDIT and DELETE buttons are triggering the functions.  
  </p>
  <a class="btn  btn-lg" href="createEvent.php" role="button">Add event</a>
   
</div>
        
       
                <div class="row mb-2" id="result3">
